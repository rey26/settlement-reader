 ...
 */
final class Version20230828030338 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE settlement (id INT NOT NULL, parent_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, mayor_name VARCHAR(255) NOT NULL, city_hall_address VARCHAR(255) NOT NULL, phone VARCHAR(30) DEFAULT NULL, fax VARCHAR(255) DEFAULT NULL, email VARCHAR(255) DEFAULT NULL, coat_of_arms_path VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
